...
{
	public abstract class BaseDao<T> : IBaseDao<T> where T : class, IBaseIdEntity<System.Guid>
	{
		internal RootDao<T, System.Guid> Dao;

		protected BaseDao(DbContext context)
		{
			Dao = new RootDao<T, System.Guid>(context);
		}
